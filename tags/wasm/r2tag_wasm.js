 ...
 * @returns {Uint8Array}
 */
export function export_tag(sav, tag_name) {
    const ptr0 = passArray8ToWasm0(sav, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(tag_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.export_tag(ptr0, len0, ptr1, len1);
    if (ret[3]) {
 ...
 * @returns {string[]}
 */
export function get_tag_names(sav) {
    const ptr0 = passArray8ToWasm0(sav, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_tag_names(ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {any}
 */
export function import_tags(sav, items) {
    const ptr0 = passArray8ToWasm0(sav, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.import_tags(ptr0, len0, items);
    if (ret[2]) {
 ...
 */
export function save_version(bytes) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.save_version(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
 ...
 * @returns {string}
 */
export function tag_name_in(r2tag) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(r2tag, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.tag_name_in(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('r2tag_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
